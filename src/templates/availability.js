...
export default class AvailabilityTemplate extends React.Component {
	constructor(props) {
		...
		this.state = {
			...
			month: this.hasQueryPart('month') ?
				moment()
					.set('month', this.getQueryPart('month'))
					.format('M') :
				43,
										...
										<li className="row">
											<div className="col-6">
												...
												<select name="event_location_id">
													...
													<option value="7">
														Andolini's Restaurant - Andover, MA
													</option>
													<option value="295">
													...
													<option value="2">
														Aqua Turf Club - Palantsville, CT
													</option>
													<option value="12">
														Arlington Town Hall Auditorium - Arlington, MA
													</option>
													<option value="297">
														Atkinson Resort &amp;Country Club - Atkinson, NH
													</option>
													<option value="282">
														Atlantic Beach Club - Newport, RI
													</option>
													<option value="13">Atlantica - Cohasset, MA</option>
													<option value="14">
														Bancroft Hall - Cohasset, MA
													</option>
													<option value="15">
														Barn at Gibbet Hill - Groton, MA
													</option>
													<option value="298">
													...
													<option value="300">
														Best Western Marlboro - Marlborough, MA
													</option>
													<option value="301">
													...
													<option value="18">
														Boston Harvard Club - Boston, MA
													</option>
													<option value="306">
														Boston Marriot Burlington - Burlington, MA
													</option>
													<option value="307">
														Boston Marriot Cambridge - Cambridge, MA
													</option>
													<option value="308">
														Boston Marriot Longwharf - Boston, MA
													</option>
													<option value="309">
														Boston Marriot Peabody Hotel - Peabody, MA
													</option>
													<option value="310">
														Boston Marriot Quincy - Quincy, MA
													</option>
													<option value="19">
														Boston Marriott Copley Square - Boston, MA
													</option>
													<option value="20">
														Boxborough Holiday Inn - Boxborough, MA
													</option>
													<option value="21">
														Bradford Country Club - North Andover, MA
													</option>
													<option value="311">
													...
													<option value="312">
														Butternut Farm Golf Club - Stow, MA
													</option>
													<option value="24">
														Café Escadrille - Burlington, MA
													</option>
													<option value="313">
													...
													<option value="314">
														Castle Manor Inn - Gloucester, MA
													</option>
													<option value="315">
														Castleton Banquet &amp;Conference Center - Windham,
														NH
													</option>
													<option value="316">
													...
													<option value="317">
														Colonial Hall at Rockafellas - Salem, MA
													</option>
													<option value="27">
														Colonial Hotel Gardner - Gardner, MA
													</option>
													<option value="28">
													...
													<option value="318">
														Copley Fairmont Hotel - Boston, MA
													</option>
													<option value="234">
														Cottage Park at Squam Lake - Holderness, NH
													</option>
													<option value="235">
													...
													<option value="323">
														Doubletree by Hilton Bedford Glen - Bedford, MA
													</option>
													<option value="324">
													...
													<option value="35">
														Elm Bank Wellesley - Wellesley, MA
													</option>
													<option value="36">
													...
													<option value="327">
														Fairways at Woburn Country Club - Woburn, MA
													</option>
													<option value="280">
													...
													<option value="240">
														Harbor Event Center - Portsmouth, NH
													</option>
													<option value="331">
													...
													<option value="333">
														Hawthorne Hotel on the Common - Salem, MA
													</option>
													<option value="47">
														Hellenic Center - Ipswich, MA
													</option>
													<option value="334">
														Hilton at Logan Airport - Boston, MA
													</option>
													<option value="48">
														Holiday Inn Beacon Hill - Boston, MA
													</option>
													<option value="49">
														Holy Ghost Society, Peabody - Peabody, MA
													</option>
													<option value="335">
													...
													<option value="242">
														Inn &amp;Spa at Mill Falls - Meredith, NH
													</option>
													<option value="54">
													...
													<option value="244">
														Kimball Jenkins Estate - Concord, NH
													</option>
													<option value="290">
														Kinney Bungalow - Narragansett, RI
													</option>
													<option value="245">
													...
													<option value="70">
														Millennium Hotel - Boston, MA
													</option>
													<option value="346">
														Millennium Hotel Boston - Boston, MA
													</option>
													<option value="72">
													...
													<option value="352">
														North Andover Country Club - North Andover, MA
													</option>
													<option value="82">
														Oakley Country Club - Watertown/Belmont, MA
													</option>
													<option value="83">
														Ocean Edge Resort - Brewster, MA
													</option>
													<option value="249">
														Ocean View Inn &amp;Resort - Gloucester, NH
													</option>
													<option value="293">
														OceanCliff Newport - Newport, RI
													</option>
													<option value="250">
													...
													<option value="218">
														On The Marsh - Kennenbunk, ME
													</option>
													<option value="252">Our Farm - Durham, NH</option>
													<option value="87">
														Pamet harbor Yacht Club - Truro, MA
													</option>
													<option value="88">
														Park Plaza Boston - Boston, MA
													</option>
													<option value="354">
														Peabody Essex Museum - Salem, MA
													</option>
													<option value="90">
														Peabody Marriott - Peabody, MA
													</option>
													...
													<option value="91">
														Piety Corner Club - Waltham, MA
													</option>
													<option value="92">
														Pine Hill Pavilion - Plymouth, MA
													</option>
													<option value="93">Pine Ridge - Oxford, MA</option>
													<option value="94">
														Pluming Museum - Watertown, MA
													</option>
													<option value="255">
													...
													<option value="95">
														Princeton Station - North Chelmsford, MA
													</option>
													<option value="355">
													...
													<option value="279">
														Publick House - Sturbridge, NJ
													</option>
													<option value="257">
														Radison Nashua - Nashua, NH
													</option>
													<option value="96">Rafael's - Walpole, MA</option>
													<option value="219">
														Red Barn at Outlook Farm - South Berwick, ME
													</option>
													<option value="258">
														Red Jacket Resort - North Conway, NH
													</option>
													<option value="97">
														Red Lion Inn - Cohassett, MA
													</option>
													<option value="98">
														Renaissance Boston Patriot Place - Foxboro, MA
													</option>
													<option value="99">
														Renaissance Golf Club - Haverhill, MA
													</option>
													<option value="356">
														Reneissance Boston Waterfront Hotel - Boston, MA
													</option>
													<option value="101">
														Restaurant Dante - Watertown, MA
													</option>
													<option value="103">
														Ritz Boston Common - Boston, MA
													</option>
													<option value="259">
														River Mill at Dover Landing - Dover, NH
													</option>
													<option value="104">
														River Mill Dover Landing - Dover, MA
													</option>
													<option value="3">
														Riverside Knights Banquet Hall - North
														Grosvenordale, CT
													</option>
													<option value="105">
														Robert Trent Paine Estate - Waltham, MA
													</option>
													<option value="106">
														Rockport Art Association - Rockport, MA
													</option>
													<option value="107">
														Rockport Country Club - Rockport, MA
													</option>
													<option value="108">
														Royal Sonesta Cambridge - Cambridge, MA
													</option>
													<option value="357">
													...
													<option value="109">
														Salem Country Club - Peabody, MA
													</option>
													<option value="358">
														Salem Waterfront Hotel - Salem, MA
													</option>
													<option value="111">
														Salvatores - Lawerence, MA
													</option>
													<option value="112">
														Sankaty Head Golf Club - Nantucket, MA
													</option>
													<option value="359">
														Saphire Estate (Saphire Event Group) - Sharon, MA
													</option>
													<option value="264">
														Seacoast Science Center - Rye, NH
													</option>
													<option value="360">
														Seaport World Trade Center &amp;Hotel - Boston, MA
													</option>
													<option value="361">
														Searles Castle at Windham - Windham, NH
													</option>
													<option value="220">
														Sebasco Harbor Resort - Phippsburg Maine, ME
													</option>
													<option value="222">
														Senator Inn &amp;Spa - Augusta ME - Augusta, ME
													</option>
													<option value="265">
													...
													<option value="365">
														Sheraton Norwood Hotel - Norwood, MA
													</option>
													<option value="119">
														Sherry Zide - Cabridge, MA
													</option>
													<option value="366">
														Sky Meadow Country Club - Nashua, NH
													</option>
													<option value="120">
														Smith and Wollensky-Back Bay - Boston, MA
													</option>
													...
													<option value="124">
														Spinellis Lynnfield - Lynnfield, MA
													</option>
													<option value="368">
													...
													<option value="369">
														Stevens' Estate - North Andover, MA
													</option>
													<option value="129">
														Stonehedge Inn - Tyngsboro, MA
													</option>
													<option value="130">
														Stonehurst Estate - Waltham, MA
													</option>
													<option value="267">
														Stonehurst Manor - North Conway, NH
													</option>
													<option value="131">
														Stonhedge Inn &amp;Spa - Tynsgboro, MA
													</option>
													...
													<option value="139">
														Tewksbury Knights of Columbus - Tewksbury, MA
													</option>
													<option value="371">
														Tewskbury Country Club - Tewksbury, MA
													</option>
													<option value="140">
														The Adams Inn - Quincy, MA
													</option>
													<option value="141">
														The Atlantica - Cohasset, MA
													</option>
													<option value="142">
														The Barn at Gibbett Hill - Groton, MA
													</option>
													<option value="372">
													...
													<option value="147">
														The Connors Estate - Dover, MA
													</option>
													<option value="148">
														The Corsair &amp;Cross Rip - Dennisport, MA
													</option>
													<option value="376">
														The Crowne Plaza Nashua - Nashua, NH
													</option>
													<option value="149">
														The Essex Room, Woodmans - Essex, MA
													</option>
													<option value="150">
													...
													<option value="378">
														The Fireside Grille - Middleboro, MA
													</option>
													<option value="379">
														The Four Seasons - Boston, MA
													</option>
													<option value="151">
														The Gloucester House - Gloucester, MA
													</option>
													...
													<option value="269">
														The Mile Away - Milford, NH
													</option>
													<option value="155">
														The Pierce House - Lincoln, MA
													</option>
													<option value="156">
														The Publick House Inn - Sturbridge, MA
													</option>
													<option value="157">
														The Renaissance - Foxboro, MA
													</option>
													<option value="158">
														The River Club - Scituate, MA, MA
													</option>
													<option value="159">
														The Seaview - Dennisport, MA
													</option>
													<option value="160">
														The State Room - Boston, MA
													</option>
													<option value="271">
														The Summit Resort - Laconia, NH
													</option>
													<option value="161">
														The Villa - East Bridgewater, MA
													</option>
													<option value="162">
														Theodore Carmone - Foxboro, MA
													</option>
													<option value="163">
													...
													<option value="167">
														Trustee Room at Boston University - Boston, MA
													</option>
													<option value="381">
														Tupper Manor - Beverly, MA
													</option>
													<option value="382">
														Turner Hill Estate - Ipswich, MA
													</option>
													...
													<option value="175">
														Vesper Country Club - Tyngsborough, MA
													</option>
													...
													<option value="177">
														Wachusett Mountian - Princeton, MA
													</option>
													<option value="178">
													...
													<option value="190">
														Wequassett - Harwich Cape Cod, MA
													</option>
													<option value="191">
														Wequassett Resort Chatham MA - Chatham, MA
													</option>
													<option value="192">
													...
													<option value="274">
														White Mountain Resort - North Conway, NH
													</option>
													<option value="275">
													...
													<option value="204">
														Wyndham Boston Andover - Andover, MA
													</option>
													<option value="225">
											...
											<div className="col-6">
												<label htmlFor="event_location_name">
													Event Venue (if not listed)
												</label>
