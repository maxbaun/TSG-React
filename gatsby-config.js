  ...
  plugins: [
    ...
    'gatsby-plugin-sass',
    {
      ...
      options: {
        ...
        normalizers: normalizers => [...normalizers.filter(n => n.name !== 'downloadMediaFiles')],
          ...
          return entities.map(entity => {
            ...
            sizes.forEach(size => {
              ...
              if (entity.media_details.sizes[size]) {
                const width = entity.media_details.sizes[size].width
                  ? parseFloat(entity.media_details.sizes[size].width)
                  : null;
                const height = entity.media_details.sizes[size].height
                  ? parseFloat(entity.media_details.sizes[size].height)
                  : null;
