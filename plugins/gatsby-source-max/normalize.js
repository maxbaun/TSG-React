...
exports.excludeUnknownEntities = function (entities) {
  return entities.filter(function (e) {
    return e.wordpress_id || e.__type === `wordpress__wp_settings`;
  });
...
exports.mapPostsToTagsCategories = function (entities) {
  ...
  return entities.map(function (e) {
    ...
    var entityHasTags = e.tags && Array.isArray(e.tags) && e.tags.length;
    ...
    var entityHasCategories = e.categories && Array.isArray(e.categories) && e.categories.length;
